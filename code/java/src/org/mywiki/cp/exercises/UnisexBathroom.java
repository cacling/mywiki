...
public class UnisexBathroom {
	...
	class Man extends Thread {
	  ...
	  public Man(UnisexBathroom bath) {
	    this.bath = bath;
	  }
	  public void run() {
	    while(true) {
	...
	class Woman extends Thread {
	  ...
	  public Woman(UnisexBathroom bath) {
	    this.bath = bath;
	  }
	  public void run() {
	    while(true) {
    ...
    class Building {
	  ...
	  public Building(String[] args) {
	    ...
	    try {
	      ...
	      UnisexBathroom bath = new UnisexBathroom(Math.min(numMen, numWomen) - 1);
